...
class Invoice(BaseEntity):
    ...
    applied_amount: Money = Field(default=None, alias="AppliedAmount")
    balance_remaining: Money = Field(default=None, alias="BalanceRemaining")
    ...
    suggested_discount_amount: Money = Field(
