...
from qb_cli.qbxml.sales_order import parse_query_response


FIXTURE = Path(__file__).parent.parent.parent / "fixtures" / "qbxml_responses" / "sales_order_query_sample.xml"
